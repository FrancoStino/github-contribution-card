# GitHub Contribution Card Action

A GitHub Action to generate contribution stats SVG files with rate limit awareness.
...
This Action runs in GitHub Actions with no timeout constraints and includes built-in rate limiting.
...
jobs:
  update-stats:
    ...
    steps:
      ...
      - name: Generate GitHub Contribution Card SVG
